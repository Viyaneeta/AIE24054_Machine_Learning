#repeating a1 and a2 with all the 196 features
#The improvement shows more features help, but linear regression still isn't the right model for this dataset since it's a classification problem
import os
import pandas as pd
import numpy as np
...
print("Test Metrics (All Features):")
